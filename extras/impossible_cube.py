...
class ImpossibleCube(Object3D):
    def __init__(self, object_material=SurfaceMaterial, stencil_ref_offset=0) -> None:
        super().__init__()

        ref = stencil_ref_offset
